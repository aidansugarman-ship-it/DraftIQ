...
const FEATURES = [
  {
    ...
    sub:      'Why Start + Why Sit takes, injury impact, hot/cold streaks across all four sports',
    color:    colors.green,
    delay:    400,
  },
  {
    ...
    sub:      'Spot trade windows on every roster — hot hitters to flip, cold ones to grab cheap',
    color:    colors.purple,
    delay:    550,
  },
  {
